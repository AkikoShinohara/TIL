...
- [ .parallax_layerbaseクラス ・ .parallax_layerbackクラス ] → これらは視差要素のスクロール速度を決定するために使用され、Z軸方向（モニターの奥）に向かって移動する
 ...
 [![Image from Gyazo](https://i.gyazo.com/930878ab9a1c893a913229d46b277f27.gif)](https://gyazo.com/930878ab9a1c893a913229d46b277f27)
...
## モバイルでは上記パララックスは動かない
- 上記で説明したコードではスマホなどの端末では動かない・***PC専用***

## プラグイン「universal parallax」 / スマホなどのモバイル端末でもパララックス効果を出したい場合は、各種プラグインが必要
- cssのプロパティで3Dビューポート（奥行き構造）を構成し、その上で各要素の奥行きの差を設定している点がポイント
　 - 要素が奥にあるほど動きは遅くなる
   - 要素が手前にある程動きが早くなる
...
***プラグイン使用 Jquery ↓ ***
[![Image click](https://i.gyazo.com/a80ba8b067ff162ea738e287750494fb.gif)](https://gyazo.com/a80ba8b067ff162ea738e287750494fb)
